    ...
    <div style={{ width: '100%', background: 'var(--paper-warm)', color: 'var(--ink)', fontFamily: 'var(--sans)' }}>
      ...
      <section className="sec" style={{ padding: '24px var(--px) 0' }}>
        <div style={{ position: 'relative' }}>
          <div className="hero-img" style={{ position: 'relative', background: '#f2ebce', border: '1px solid var(--ink)', overflow: 'hidden' }}>
            {article.coverImage ? (
              <>
                <Image src={article.coverImage} alt={article.coverAlt ?? article.title} fill className="hero-img-inner" style={{ objectFit: 'cover', objectPosition: 'center top' }} />
