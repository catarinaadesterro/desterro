/* DESTERRO — Sobre o Jornal */
const SobreJornalPage = () => {
  return (
    <div style={{
      width: 1280,
      ...
      {/* TITLE BLOCK — definição em estilo verbete */}
      <section style={{ padding: "20px 40px 0", maxWidth: 1100 }}>
        <div className="eyebrow" style={{ marginBottom: 16 }}></div>
        <h1 style={{
          fontFamily: "var(--serif)", fontWeight: 800,
          fontSize: 132, lineHeight: .92, letterSpacing: "-.03em",
          margin: "0 0 18px"
        }}>
        ...
        <p style={{ fontFamily: "var(--serif)", fontWeight: 300, fontSize: 26, lineHeight: 1.32, color: "var(--gray-1)", margin: "0 0 8px", maxWidth: 880 }}>Um jornal de ideias e reflexões. Não é para quem busca respostas, é para quem ainda insiste em pensar no meio do caos.

        </p>
      </section>

      {/* BODY — single column with margin index */}
      <section style={{ padding: "44px 40px 0", display: "grid", gridTemplateColumns: "120px 1fr 280px", gap: 36, alignItems: "start" }}>
        {/* margin index */}
        <aside style={{ position: "sticky", top: 20 }}>
          <div className="kicker" style={{ color: "var(--gray-2)", marginBottom: 10, fontSize: 10 }}></div>
          <div className="mono" style={{ fontSize: 10, letterSpacing: ".18em", textTransform: "uppercase", color: "var(--gray-2)", lineHeight: 1.6 }}>
        ...
        <article style={{ fontFamily: "var(--serif)", fontSize: 19, lineHeight: 1.7, color: "var(--ink-2)" }}>
          ...
          {/* AZUL pull quote — mas também é meu sobrenome */}
          ...
          <p style={{ margin: "0 0 18px" }}>Assim, se tudo está sempre mudando, isso aqui pode ser visto como uma recusa em ser só levada pelo movimento ou, no mínimo, uma tentativa de escolher para onde ir no meio dele.
          ...
          <div className="byline" style={{ marginTop: 24, color: "var(--gray-2)" }}>— Catarina Desterro.
        ...
        <aside style={{ position: "sticky", top: 20 }}>
          <div style={{ border: "1px solid var(--ink)" }}>
            ...
            <div style={{ padding: 16, background: "var(--paper)" }}>
              ...
              <div key={i} style={{
                padding: "10px 0",
                borderTop: i === 0 ? 0 : "1px solid var(--gray-5)"
              }}>
                  <div className="kicker" style={{ color: "var(--gray-2)", marginBottom: 4, fontSize: 10 }}>{row[0]}</div>
                  <div style={{ fontFamily: "var(--serif)", fontSize: 15, lineHeight: 1.3 }}>{row[1]}</div>
                </div>
              )}
            </div>
          </div>
...
window.SobreJornalPage = SobreJornalPage;