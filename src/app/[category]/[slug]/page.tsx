    ...
    <div style={{ width: '100%', background: 'var(--paper-warm)', color: 'var(--ink)', fontFamily: 'var(--sans)' }}>
      ...
      <section className="sec" style={{ padding: '24px var(--px) 0' }}>
        <div style={{ position: 'relative' }}>
          <div className="hero-img" style={{ height: 500, position: 'relative', background: '#efe8d6', border: '1px solid var(--ink)', overflow: 'hidden' }}>
            {article.coverImage ? (
              <>
                <Image src={article.coverImage} alt={article.coverAlt ?? article.title} fill style={{ objectFit: 'contain', objectPosition: 'center center' }} />
